defmodule Chinook.API.Schema do
  use Absinthe.Schema
  use Absinthe.Relay.Schema, :modern

  alias Absinthe.Relay.Node.ParseIDs
  alias Chinook.API.Schema.Album
  alias Chinook.API.Schema.Artist
  alias Chinook.API.Schema.Customer
  alias Chinook.API.Schema.Employee
  alias Chinook.API.Schema.Filter
  alias Chinook.API.Schema.Genre
  alias Chinook.API.Schema.Invoice
  alias Chinook.API.Schema.Playlist
  alias Chinook.API.Schema.Track
